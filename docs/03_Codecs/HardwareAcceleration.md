...
Document the HardwareAcceleration responsibilities in the 03_Codecs documentation area.

## Overview

Covers codec interfaces, FFmpeg encoding, FFprobe metadata, FFplay preview, HAP, NotchLC, ProRes, DNxHR, image sequences, GPU codecs, presets, QC, and benchmarks.
...
Use this document as the reference when implementing or reviewing HardwareAcceleration changes.
