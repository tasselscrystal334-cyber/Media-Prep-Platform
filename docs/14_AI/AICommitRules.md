...
Document the AICommitRules responsibilities in the 14_AI documentation area.
...
Use this document as the reference when implementing or reviewing AICommitRules changes.
