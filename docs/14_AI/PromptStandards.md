...
Document the PromptStandards responsibilities in the 14_AI documentation area.
...
Use this document as the reference when implementing or reviewing PromptStandards changes.
