# AIDocumentationPolicy

## Purpose

Document the AIDocumentationPolicy responsibilities in the 14_AI documentation area.

## Overview

Covers Codex and Claude collaboration, prompt standards, review checklists, background information, documentation policy, and AI commit rules.
...
Use this document as the reference when implementing or reviewing AIDocumentationPolicy changes.
