...
Document the StatusBar responsibilities in the 05_UI documentation area.
...
Use this document as the reference when implementing or reviewing StatusBar changes.
