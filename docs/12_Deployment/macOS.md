...
Document the macOS responsibilities in the 12_Deployment documentation area.
...
Use this document as the reference when implementing or reviewing macOS changes.
