...
Document the Installer responsibilities in the 12_Deployment documentation area.
...
Use this document as the reference when implementing or reviewing Installer changes.
