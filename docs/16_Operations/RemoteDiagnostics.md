...
Document the RemoteDiagnostics responsibilities in the 16_Operations documentation area.
...
Use this document as the reference when implementing or reviewing RemoteDiagnostics changes.
