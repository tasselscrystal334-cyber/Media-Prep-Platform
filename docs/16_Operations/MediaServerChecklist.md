# MediaServerChecklist

## Purpose

Document the MediaServerChecklist responsibilities in the 16_Operations documentation area.
...
Use this document as the reference when implementing or reviewing MediaServerChecklist changes.
