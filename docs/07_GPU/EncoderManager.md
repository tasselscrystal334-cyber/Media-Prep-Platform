...
Document the EncoderManager responsibilities in the 07_GPU documentation area.
...
Use this document as the reference when implementing or reviewing EncoderManager changes.
