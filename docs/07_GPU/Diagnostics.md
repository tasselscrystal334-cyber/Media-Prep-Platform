...
Document the Diagnostics responsibilities in the 07_GPU documentation area.
...
Use this document as the reference when implementing or reviewing Diagnostics changes.
