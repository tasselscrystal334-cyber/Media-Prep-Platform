...
Document the ThreadingModel responsibilities in the 01_Architecture documentation area.
...
Use this document as the reference when implementing or reviewing ThreadingModel changes.
