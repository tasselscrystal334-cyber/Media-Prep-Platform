...
Document the ErrorHandling responsibilities in the 01_Architecture documentation area.
...
Use this document as the reference when implementing or reviewing ErrorHandling changes.
