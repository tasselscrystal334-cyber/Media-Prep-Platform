...
Document the GPUTesting responsibilities in the 11_Testing documentation area.
...
Use this document as the reference when implementing or reviewing GPUTesting changes.
