...
Document the CompatibilityTesting responsibilities in the 11_Testing documentation area.

## Overview

Covers unit, integration, regression, performance, stress, compatibility, GPU, codec, UI, E2E, benchmark, and test data strategy.
...
Use this document as the reference when implementing or reviewing CompatibilityTesting changes.
