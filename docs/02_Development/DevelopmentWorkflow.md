...
Document the DevelopmentWorkflow responsibilities in the 02_Development documentation area.
...
Use this document as the reference when implementing or reviewing DevelopmentWorkflow changes.
