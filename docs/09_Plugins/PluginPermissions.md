...
Document the PluginPermissions responsibilities in the 09_Plugins documentation area.

## Overview

Covers plugin SDK, manifest, lifecycle, API, permissions, repository, examples, and extension safety.
...
Use this document as the reference when implementing or reviewing PluginPermissions changes.
