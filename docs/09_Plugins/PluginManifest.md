...
Document the PluginManifest responsibilities in the 09_Plugins documentation area.
...
Use this document as the reference when implementing or reviewing PluginManifest changes.
