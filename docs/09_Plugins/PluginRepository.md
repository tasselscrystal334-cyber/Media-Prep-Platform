...
Document the PluginRepository responsibilities in the 09_Plugins documentation area.
...
Use this document as the reference when implementing or reviewing PluginRepository changes.
