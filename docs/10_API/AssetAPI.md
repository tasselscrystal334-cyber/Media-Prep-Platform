...
Document the AssetAPI responsibilities in the 10_API documentation area.
...
Use this document as the reference when implementing or reviewing AssetAPI changes.
