...
Document the ApplicationAPI responsibilities in the 10_API documentation area.

## Overview

Covers application, project, asset, codec, validation, Python, CLI, plugin, and future REST APIs.
...
Use this document as the reference when implementing or reviewing ApplicationAPI changes.
