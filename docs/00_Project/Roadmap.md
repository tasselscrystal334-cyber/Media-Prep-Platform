...
Document the Roadmap responsibilities in the 00_Project documentation area.
...
Use this document as the reference when implementing or reviewing Roadmap changes.
