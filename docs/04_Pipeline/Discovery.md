...
Document the Discovery responsibilities in the 04_Pipeline documentation area.
...
Use this document as the reference when implementing or reviewing Discovery changes.
