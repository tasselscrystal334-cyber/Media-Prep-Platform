...
Document the Hash responsibilities in the 04_Pipeline documentation area.
...
Use this document as the reference when implementing or reviewing Hash changes.
