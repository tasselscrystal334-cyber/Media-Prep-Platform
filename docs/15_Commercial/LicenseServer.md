...
Document the LicenseServer responsibilities in the 15_Commercial documentation area.
...
Use this document as the reference when implementing or reviewing LicenseServer changes.
