...
Document the CommercialRoadmap responsibilities in the 15_Commercial documentation area.
...
Use this document as the reference when implementing or reviewing CommercialRoadmap changes.
