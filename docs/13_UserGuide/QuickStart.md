...
Document the QuickStart responsibilities in the 13_UserGuide documentation area.
...
Use this document as the reference when implementing or reviewing QuickStart changes.
