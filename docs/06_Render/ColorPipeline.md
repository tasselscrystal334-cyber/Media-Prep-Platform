...
Document the ColorPipeline responsibilities in the 06_Render documentation area.

## Overview

Covers render graph, frame cache, texture cache, color pipeline, LUT, subtitle, watermark, scaling, effects, GPU scheduling, render queue, HDR, alpha, and performance.
...
Use this document as the reference when implementing or reviewing ColorPipeline changes.
