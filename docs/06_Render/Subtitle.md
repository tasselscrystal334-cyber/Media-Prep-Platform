...
Document the Subtitle responsibilities in the 06_Render documentation area.
...
Use this document as the reference when implementing or reviewing Subtitle changes.
