...
Document the AssetDatabase responsibilities in the 08_Database documentation area.
...
Use this document as the reference when implementing or reviewing AssetDatabase changes.
