...
Document the MetadataCache responsibilities in the 08_Database documentation area.
...
Use this document as the reference when implementing or reviewing MetadataCache changes.
